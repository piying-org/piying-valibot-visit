...
import { ConditionAction, GroupControlAction, RawConfigAction, VirtualGroupAction } from './action';
...
export type Schema =
  ...
  | v.VariantSchema<string, v.VariantOptions<string>, v.ErrorMessage<v.VariantIssue> | undefined>
  ...
  | v.CustomSchema<v.BaseSchema<unknown, unknown, v.BaseIssue<unknown>>, v.ErrorMessage<v.CustomIssue> | undefined>;

export type SchemaOrPipe =
  | Schema
  | v.SchemaWithPipe<
      // @ts-ignore // TODO: Remove comment
      readonly [Schema, ...(Schema | v.PipeAction<any, any, v.BaseIssue<unknown>>)[]]
    >;
...
export type IntersectSchema = v.IntersectSchema<v.IntersectOptions, v.ErrorMessage<v.IntersectIssue> | undefined>;
